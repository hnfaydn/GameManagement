...
public class RMRExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(RMRDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new RMRStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static RMRDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static RMRDateTimeConverter dateTimeConverter = new RMRStandardDateTimeConverter();

    public RMRExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public RMRExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new RMRMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=RMRHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,RMRExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=RMRHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
