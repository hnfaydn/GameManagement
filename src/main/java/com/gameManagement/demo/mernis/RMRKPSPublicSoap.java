...
public class RMRKPSPublicSoap
{
    ...
    public RMRKPSPublicSoap(){}

    public RMRKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public RMRKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        RMRExtendedSoapSerializationEnvelope envelope= new RMRExtendedSoapSerializationEnvelope(RMRExtendedSoapSerializationEnvelope.VER11);
